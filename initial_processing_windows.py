...
with open("tweet.csv", mode='w', newline='\n',encoding="utf-8") as f:
    tweet_data.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
...
with open("tweetid_artist_track.csv", mode='w', newline='\n',encoding="utf-8") as f:
    required_mmtd_data.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
...
with open("just_tweet_ids.csv", mode='w', newline='\n',encoding="utf-8") as f:
    just_tweets_ids_df.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
