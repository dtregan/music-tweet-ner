...
with open("joined_text_artisttrack.csv", mode='w', newline='\n',encoding="utf-8") as f:
    join_df3.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
...
print(indexes_df_new.head())

#indexes_df_new.to_csv('master_noindex.csv', index=False)

with open("master_noindex.csv", mode='w', newline='\n',encoding="utf-8") as f:
    indexes_df_new.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
...
nodupes_pre_df = pd.read_csv("master_noindex.csv",dtype={'tweet_id':'Int64'},lineterminator='\n')
print('Creating new CSV - cleaning data of duplicate records, pre-processing...')
nodupes_pre_df.drop_duplicates(subset=None, inplace=True) # remove duplicate rows

# Write the results to a different file

with open("master_nodupes_pre.csv", mode='w', newline='\n',encoding="utf-8") as f:
    nodupes_pre_df.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
...
with open("manual_cleaned.csv", mode='w', newline='\n',encoding="utf-8") as f:
    cleaned_df_toexport.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
...
with open("master_nodupes_post.csv", mode='w', newline='\n',encoding="utf-8") as f:
    nodupes_post_df.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
...
with open("master_allpunc_removed.csv", mode='w', newline='\n',encoding="utf-8") as f:
    df_punc.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
...
print(track_cleaned_data_master)
...
with open("data_for_models_artist.csv", mode='w', newline='\n',encoding="utf-8") as f:
    artist_new_df.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')

#artist_new_df.to_csv("data_for_models_artist.csv",index=False)
print('data_for_models_artist.csv created.')
...
with open("data_for_models_track.csv", mode='w', newline='\n',encoding="utf-8") as f:
    track_new_df.to_csv(f, sep=",", line_terminator='\n', encoding='utf-8')
